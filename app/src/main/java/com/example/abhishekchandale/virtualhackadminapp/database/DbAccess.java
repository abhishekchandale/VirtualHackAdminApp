package com.example.abhishekchandale.virtualhackadminapp.database;
...
public class DbAccess extends SQLiteOpenHelper {
    ...
    Context context_;
    private static String databaseName = "hackApp2Db";
    ...
    public void clearComplaints(){
        ...
        db.execSQL("DELETE FROM " + table_complaintDetails);
        db.close();
    }
